...
const Navbar = () => {
  ...
  return (
    <nav className=" grid grid-cols-2  items-center py-4 px-6 lg:py-6 lg:px-20 justify-between mb-10">
      <div className="py-4 lg:py-6 max-w-[20rem] md:max-w-[28rem] ">
      ...
      <div >
        <Menu
          as="div"
          className="flex z-50 items-center gap-x-3 relative w-[53px] ml-auto"
        >
          <MenuButton className="flex flex-col items-center justify-center text-white font-bold bg-yellow-500 w-10 h-10 rounded-full">
            {currentUser.email.slice(0, 1).toUpperCase()}
          </MenuButton>
          <MenuTransition>
            <div className="block absolute bg-white right-0 mt-8 px-4  py-4 rounded-md ">
              ...
              <MenuItem>
                <button
                  onClick={logUserOut}
                  className="px-6 py-1 rounded-3xl mt-6 text-white text-sm bg-red-500"
                >
                  Logout
                </button>
              </MenuItem>
